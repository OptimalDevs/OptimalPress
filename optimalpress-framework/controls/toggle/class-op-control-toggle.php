	...
	public function render_field( $value, $name ) {
		...
		<div class="input op-control-toggle">
			<div class="onoffswitch">
				<input type="checkbox" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>" class="onoffswitch-checkbox op-input <?php echo $this->field_classes; ?>" value="1" <?php checked( $value, '1' ); ?> >
