...
class OP_Control_ColorPicker extends Optimalpress_Control {
	...
	protected function render_field( $value, $name ) {
		...
		<div class="input op-control-colorpicker">
			<input type="text" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>" class="optimalpress-colorpicker op-input <?php echo esc_attr( $this->field_classes ); ?>" value="<?php echo esc_attr( $value ); ?>" />
		</div>
		<?php
