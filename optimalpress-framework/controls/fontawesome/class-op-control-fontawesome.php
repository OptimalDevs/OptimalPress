...
class OP_Control_FontAwesome extends Optimalpress_Control {
	...
	public function render_field( $value, $name ) {
		...
		<div class="input op-control-fontawesome">
			<input type="hidden" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>" class="widefat edit-menu-item-fontawesome op-fontawesome-selected-icon op-input <?php echo $this->field_classes; ?>" value="<?php echo esc_attr( $value ); ?>" />
